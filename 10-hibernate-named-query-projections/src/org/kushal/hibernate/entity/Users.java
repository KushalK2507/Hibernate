...
@Entity
@NamedQuery(name = "Users.byID", query = "from Users where "
		+ "userId = :id")
@NamedNativeQuery(name="Users.byName", query="select from users_details where username = :name" , resultClass=Users.class)

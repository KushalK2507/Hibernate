...
public class App {
	...
	public static void main(String[] args) {
		...
		Query createQuery2 = session.createQuery("from Customer where network_Provider = :networkProvider");
		createQuery2.setParameter("networkProvider", "Airtel"); // setString("networkProvider", "Airtel");
		...
		Query createQuery3 = session
				.createQuery("select name from Customer where telephoneNumber like :telephoneNumber");
		createQuery3.setString("telephoneNumber", "9%");
		...
		namedQuery2.setString("networkProvider", "Voda");
		...
		namedNativeQuery.setString("telephoneNumber", "6%");
		...
		namedNativeQuery2.setString("networkProvider", "BSNL");
		...
		Criteria result = createCriteria2.setProjection(
				Projections.projectionList().add(Projections.property("customerId")).add(Projections.property("name")))
